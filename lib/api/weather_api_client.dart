import 'dart:convert';
import 'package:Haritkranti/api/http_exception.dart';
import 'package:Haritkranti/model/weather.dart';
...
class WeatherApiClient {
  ...
  /*Future<Weather> getLatitudeData( {double latitude, double longitude}) async {
